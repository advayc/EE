...
\titleformat{\subsection}{\normalfont\large\bfseries\itshape}{\thesubsection}{1em}{}[\vspace{0.3ex}]
...
{\Large\bfseries The effectiveness of Lossy compression algorithms}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{image15.png}
...
\caption{Original Image Kodak Image 20 (Fink, 2012)}
\label{fig:kodak_original}
\end{figure}
...
\caption{Cropped JPEG Output at Quality 95 (175 KB)}
\label{fig:jpeg_q95}
\end{figure}
...
\caption{JPEG Output at Quality 75 (93 KB)}
\label{fig:jpeg_q75}
\end{figure}
...
\caption{JPEG Output at Quality 50 (52 KB)}
\label{fig:jpeg_q50}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{image5.png}
\caption{JPEG Output at Quality 30 (32 KB)}
\label{fig:jpeg_q30}
\end{figure}
...
\caption{JPEG Output at Quality 10 (20 KB)}
\label{fig:jpeg_q10}
\end{figure}
...
\begin{table}[htbp]
\centering
\caption{JPEG Compression Results for Kodak Image 20}
\label{tab:jpeg_results}
\begin{tabular}{ccccc}
\toprule
\textbf{Quality} & \textbf{File Size (KB)} & \textbf{Compression Ratio} & \textbf{PSNR (dB)} & \textbf{SSIM} \\
\midrule
...
This behavior matches analyses of JPEG performance.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{image14.png}
\caption{JPEG Quality vs PSNR Curve}
\label{fig:jpeg_psnr_curve}
\end{figure}
...
\caption{Original WAV Spectrogram}
\label{fig:wav_original}
\end{figure}
...
\caption{MP3 128 kbps Spectrogram}
\label{fig:mp3_128}
\end{figure}

Most harmonic detail is preserved. Higher frequencies above 14 kHz begin to weaken. This bitrate is commonly rated MOS $\approx$ 4.0 in listening tests. Music remains clear.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{image8.png}
\caption{MP3 64 kbps Spectrogram}
\label{fig:mp3_64}
\end{figure}
...
\caption{MP3 32 kbps Spectrogram}
\label{fig:mp3_32}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{image11.png}
\caption{MP3 16 kbps Spectrogram}
\label{fig:mp3_16}
\end{figure}
...
\begin{table}[htbp]
\centering
\caption{MP3 Compression Results}
\label{tab:mp3_results}
\begin{tabular}{cccc}
\toprule
\textbf{Bitrate (kbps)} & \textbf{Approx. File Size} & \textbf{Compression Ratio} & \textbf{Expected MOS} \\
\midrule
128 & $\sim$900 KB & $\sim$12:1 & 4.0 \\
64 & $\sim$450 KB & $\sim$24:1 & 3.5 \\
32 & $\sim$230 KB & $\sim$47:1 & 2.7 \\
16 & $\sim$120 KB & $\sim$90:1 & 2.0--2.5 \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{MP3 Bitrate vs MOS Curve}
\label{fig:mp3_mos_curve}
\end{figure}
...
\item Davidson, G., et al. ``High Quality Audio Coding with MDCTNet.'' \textit{arXiv}, Dec. 2022, \url{https://arxiv.org/abs/2212.04583}.

\item Fassina, Felipe. ``Lossy Compression Algorithms Explained.'' \textit{Bitmovin}, 2020, \url{https://bitmovin.com/blog/lossy-compression-algorithms/}.

\item Fink, Alan. \textit{P51 Mustang (kodim20)}. Kodak Lossless True Color Image Suite, 30 Oct. 2012, \url{https://r0k.us/graphics/kodak/kodim20.html}.

\item Gonzalez, Rafael C., and Richard E. Woods. \textit{Digital Image Processing}. 4th ed., Pearson, 2018.

\item Hamilton, James D. ``Psychoacoustic Models for Perceptual Audio Coding.'' \textit{Journal of the Audio Engineering Society}, vol. 40, no. 3, 1992.

\item ``Lossless and Lossy Compression.'' \textit{TechTarget}, 2023, \url{https://www.techtarget.com/whatis/definition/lossless-and-lossy-compression}.

\item Rao, K. R., et al. \textit{Discrete Cosine Transform: Algorithms, Advantages, Applications}. Academic Press, 1990.

\item Ryerraballi, R. Yerraballi. ``JPEG Compression Lecture Notes.'' The University of Texas, 2020, \url{https://users.ece.utexas.edu/~ryerraballi/MSB/pdfs/M4L1.pdf}.

\item Shang, Z., et al. ``Study of the Subjective and Objective Quality of High Motion Live Streaming Videos.'' \textit{IEEE Transactions on Image Processing}, 2021, doi:10.1109/TIP.2021.3136723.

\item Smith, Steven W. \textit{Digital Signal Processing: A Practical Guide for Engineers and Scientists}. Elsevier, 2003.

\item Wang, Zhou, and Alan C. Bovik. ``A Universal Image Quality Index.'' \textit{IEEE Signal Processing Letters}, vol. 9, no. 3, 2002, \url{https://www.cns.nyu.edu/pub/lcv/wang03-preprint.pdf}.

\item Wiegand, Thomas, and Heiko Schwarz. ``Entropy Coding in Modern Compression Standards.'' Fraunhofer HHI, \url{https://www.hhi.fraunhofer.de/en/departments/vca/people-and-contact/thomas-wiegand}.

\item ``Sample WAV Files.'' \textit{File-Examples.com}, 2024, \url{https://file-examples.com/index.php/sample-audio-files/sample-wav-download/}.

\item ``JFIF: JPEG File Interchange Format, Version 1.02.'' \textit{W3C}, 1992, \url{https://www.w3.org/Graphics/JPEG/jfif3.pdf}.

\item University of Toronto. ``Image Compression.'' \textit{MAT246 Lecture Notes}, 2018, \url{http://www.math.toronto.edu/burbulla/lecturenotes246/Chapter7.pdf}.
\end{enumerate}
